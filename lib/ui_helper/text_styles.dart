...
TextStyle textStyle11({
  ...
  return TextStyle(fontSize: 11, color: color, fontWeight: fontWeight);
}
...
TextStyle textStyle21({
  ...
  return TextStyle(fontSize: 21, color: color, fontWeight: fontWeight);
}
...
TextStyle textStyle26({
  ...
  return TextStyle(fontSize: 26, color: color, fontWeight: fontWeight);
}
...
TextStyle textStyle32({
  ...
  return TextStyle(fontSize: 32, color: color, fontWeight: fontWeight);
}
